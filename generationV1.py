...
parser.add_argument("slidesOrVideos", nargs='?', default='sm')
...
main(args.musicName, args.path,  int(args.extractionRef), int(args.computeMatrix),args.slidesOrVideos,float(args.width), args.formatOutput, args.formatOutputSound)
