...
def main(output_filename, n=3, first=None, second=None, third=None ) :
    ...
    seed_len = 1
    seed_seq = seed_generator.generate_copy_seed_sequence(seed_len,X_train, n, first, second, third)
    
    max_seq_len = 15; #Defines how long the final song is. Total song length in samples = max_seq_len * example_len
